...
- Write in accessible, lively language for people with no specialist background. Follow the workflow's editorial-voice standard: concrete words, natural rhythm, earned bite and at least one central, verified fact a reader can accurately repeat to a family member. Record that sentence and its proof in the case file; keep essential qualifications inside the sentence. The name UR NOT MAD ENOUGH gives the work energy; readers decide what to think and do from the evidence.
